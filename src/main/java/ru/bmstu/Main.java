            ...
            public enum Station {;
                public enum Manager {;
                    public enum Pump {
                        ...
                        Pump(Kind k, FuelType s) {this.k = k;this.s = s;}
                        private void c(FuelType.Vehicle v) {if (v.getfT() != s) throw new IllegalArgumentException("Неподдерживаемый тип топлива");}
                ...
                public enum FuelTank {;
                    ...
                    static {for (FuelType t : FuelType.values()) v.put(t, 0.0);}
                ...
                public static void r() {for (FuelType t:FuelType.values()){p.put(t, 0.0);s.put(t,0.0);}r=0.0;FuelTank.re();}
            }
